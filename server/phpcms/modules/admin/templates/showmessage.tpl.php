...
<title><?php //echo L('message_tips');?>提示信息</title>
<style type="text/css">
<!--
*{ padding:0; margin:0; font-size:12px}
a:link,a:visited{text-decoration:none;color:white;}
a:hover,a:active{color:#ff6600;text-decoration: underline}
.showMsg{border: 1px solid rgb(186,12,47); zoom:1; width:450px; height:172px;position:absolute;top:44%;left:50%;margin:-87px 0 0 -225px}
...
.showMsg .bottom{ background:rgb(186,12,47); margin: 0 1px 1px 1px;line-height:26px; *line-height:30px; height:26px; text-align:center}
