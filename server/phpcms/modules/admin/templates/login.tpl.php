...
<title><?php //echo L('phpcms_logon')?>喜农农内容管理系统</title>
<style type="text/css">
...
<body onload="javascript:document.myform.username.focus();" style="background-color:#3f3f3f">
<div id="login_bg" class="login_box">
    ...
    <div class="cr"><?php //echo L("copyright")?>CopyRight 2015-2016 上海农业展览馆</div>
</div>
</body>
</html>