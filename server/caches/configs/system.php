...
'upload_url' => 'http://10.0.0.3/server/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://10.0.0.3/server/statics/js/', //CDN JS
'css_path' => 'http://10.0.0.3/server/statics/css/', //CDN CSS
'img_path' => 'http://10.0.0.3/server/statics/images/', //CDN img
'app_path' => 'http://10.0.0.3/server/',//动态域名配置地址
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://10.0.0.3/server/phpsso_server',	//接口地址
