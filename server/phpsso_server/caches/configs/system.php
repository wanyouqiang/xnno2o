...
'js_path' => 'http://10.0.0.3/server/phpsso_server/statics/js/', //CDN JS
'css_path' => 'http://10.0.0.3/server/phpsso_server/statics/css/', //CDN CSS
'img_path' => 'http://10.0.0.3/server/phpsso_server/statics/images/', //CDN img
'upload_path' => PHPCMS_PATH.'uploadfile/', //上传文件路径
'app_path' => 'http://10.0.0.3/server/phpsso_server/',//动态域名配置地址
